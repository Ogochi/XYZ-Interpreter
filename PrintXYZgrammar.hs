...
instance Print Stmt where
  prt i e = case e of
    ...
    ForGen id1 id2 block -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 id1, doc (showString ":"), prt 0 id2, doc (showString ")"), prt 0 block])
...
instance Print Arg where
  prt i e = case e of
    ValArg type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id])
